...
class AppConfig {
    constructor() {
        this.config = {
            ...
            app: {
                name: 'BrowserMind',
                version: '1.0.0',
                description: 'AI That Lives in Your Browser',
                environment: this.detectEnvironment()
            },

            // Google Services Configuration
            google: {
                // OAuth Client ID - BrowserMind Project
                clientId: '981929522431-ee8jdp7aoat71ogar0o2bj69o18n5ms1.apps.googleusercontent.com',
                
                // Google Analytics
                analytics: {
                    trackingId: 'G-0BX7JR0X41',
                    enabled: true,
                    debug: false
                },
    ...
    detectEnvironment() {
        ...
        const storedEnv = localStorage.getItem('browsermind_env');
    ...
    setEnvironment(env) {
        ...
        localStorage.setItem('browsermind_env', env);
