    ...
    trackFeatureUsage() {
        ...
        if (sendButton) {
            sendButton.addEventListener('click', () => {
                this.trackEvent('feature_usage', 'send_message');
            });
        }
        ...
        if (newChatBtn) {
            newChatBtn.addEventListener('click', () => {
                this.trackEvent('feature_usage', 'new_chat');
            });
        }
        ...
        document.addEventListener('click', (e) => {
            if (e.target.classList.contains('model-select-btn')) {
                this.trackEvent('feature_usage', 'model_switch');
            }
        });
        ...
        if (authSignInBtn) {
            authSignInBtn.addEventListener('click', () => {
                this.trackEvent('feature_usage', 'auth_signin_attempt');
            });
        }
        ...
        if (exportMarkdownBtn) {
            exportMarkdownBtn.addEventListener('click', () => {
                this.trackEvent('feature_usage', 'export_markdown');
            });
        }
        
        if (exportJsonBtn) {
            exportJsonBtn.addEventListener('click', () => {
                this.trackEvent('feature_usage', 'export_json');
            });
        }
        ...
        if (hamburgerBtn) {
            hamburgerBtn.addEventListener('click', () => {
                this.trackEvent('feature_usage', 'open_sidebar');
            });
        }
    }
